...
data <- read.csv("data/data_male.csv")
...
LR1.orig<-lrm(OAB_2~age+bmi+smoke+alcohol+walking
              +HT+HL+DM+STROKE+MI+CANCER+SAS+Depression+Insomnia+Prostate_disease+PCa+Renal_disease
              +OABSS1_1+OABSS2_1+OABSS3_1+OABSS4_1,
              data = data_cc,
              x=T, y=T,linear.predictors = T)

LR2.orig<-lrm(OAB_2~age+bmi+smoke+alcohol+walking
              +HT+HL+DM+STROKE+MI+CANCER+SAS+Depression+Insomnia+Prostate_disease+PCa+Renal_disease
              +OABSS1_1+OABSS2_1+OABSS3_1+OABSS4_1
              +HbA1c+eGFR+BNP+PSA,
              data =data_cc,
...
#caclulate apparent performance
...
for(i in 1:Nboot) { 
  ...
  LR1.boot<-lrm(OAB_2~age+bmi+smoke+alcohol+walking
                +HT+HL+DM+STROKE+MI+CANCER+SAS+Depression+Insomnia+Prostate_disease+PCa+Renal_disease
                +OABSS1_1+OABSS2_1+OABSS3_1+OABSS4_1,
                data = bootsam[[i]],
                x=T, y=T,linear.predictors = T)
  
  LR2.boot<-lrm(OAB_2~age+bmi+smoke+alcohol+walking
                +HT+HL+DM+STROKE+MI+CANCER+SAS+Depression+Insomnia+Prostate_disease+PCa+Renal_disease
                +OABSS1_1+OABSS2_1+OABSS3_1+OABSS4_1
                +HbA1c+eGFR+BNP+PSA,
                data = bootsam[[i]],
  ...
  #calculate performance in original sample 
