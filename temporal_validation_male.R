...
LR1_training<-lrm(OAB_2~age+ bmi+ smoke+ alcohol+ walking
...
LR1_testing<-lrm(OAB_2~age+ bmi+ smoke+ alcohol+ walking
                 +HT+ HL+ DM+ MI+ STROKE+   Renal_disease+ CANCER+ Depression+ Insomnia+ SAS+  Prostate_disease+ PCa
                 +OABSS1_1+ OABSS2_1+ OABSS3_1+ OABSS4_1,
                 data = data_2010,
                 x=T, y=T,linear.predictors = T)

LR2_training<-lrm(OAB_2~age+ bmi+ smoke+ alcohol+ walking
                  +HT+ HL+ DM+ MI+ STROKE+   Renal_disease+ CANCER+ Depression+ Insomnia+ SAS+  Prostate_disease+ PCa
                  +OABSS1_1+ OABSS2_1+ OABSS3_1+ OABSS4_1
                  +HbA1c+eGFR+BNP+PSA,
                  data = data_20082009,
                  x=T, y=T,linear.predictors = T)
LR2_testing<-lrm(OAB_2~age+ bmi+ smoke+ alcohol+ walking
                 +HT+ HL+ DM+ MI+ STROKE+   Renal_disease+ CANCER+ Depression+ Insomnia+ SAS+  Prostate_disease+ PCa
                 +OABSS1_1+ OABSS2_1+ OABSS3_1+ OABSS4_1
                 +HbA1c+eGFR+BNP+PSA,
                 data = data_2010,
